...
const Section4: React.FC<Section4Props> = ({
    ...
    return (
        <section className="text-center py-3 px-5 w-full">
            <div className="border-[5px] border-gray-200 py-5 px-5 rounded-xl">
                <h2 className="text-lg font-dm-serif-display mb-5 font-semibold">
                    {monthTitle}
                </h2>

                <div className="grid grid-cols-7 gap-2 text-[12px] items-center h-[38px] rounded-md font-medium bg-primary text-white px-2">
                ...
                <div className="grid grid-cols-7 gap-2 gap-y-4 mt-2 px-2 text-[14px] font-semibold border-b mb-5 pb-4">
                    ...
                    {days.map((day) => (
                        <div
                            key={day}
                            className={`h-[28px] flex justify-center font-medium text-[13px] items-center rounded 
                ...
                <div className="py-4 p-10 text-xl font-bold bg-gray-200 rounded-lg justify-center">
                    {eventStatus === "Sự kiện sắp diễn ra" ? (
                        ...
                        <div className="text-[16px] text-primary font-dm-serif-display font-bold">{eventStatus}</div>
                    )}
                </div>
            </div>
        </section>
